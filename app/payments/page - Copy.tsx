...
function PaymentContent() {
  ...
  const handlePaystackPayment = async () => {
    ...
    setIsLoading(true);
    try {
      // We call the PHP file in your public_html directly
      ...
      if (data.url) {
        // Redirect the parent to the secure Paystack payment page
        window.location.href = data.url;
      } else {
        // Show the specific error from Paystack or the PHP script
